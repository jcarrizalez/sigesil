...
//echo 'SILO: ('.$_SESSION['s_ca_codigo'].') '.$_SESSION['s_ca_nombre'];
...
class HOJASOL extends tcpdf{
    ...
    function Header()
    {
		...
		$this->writeHTMLCell(0, 0, '18', '10', 'Pagina: '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, 1, 0, true, 'L');
...
<td width="5px">&nbsp;</td>
<td width="95px"><b>P. Acondicionado</b></td>
</tr>';
...
<td width="5px">&nbsp;</td>
<td width="95px" align="right">'.$pacondicionado_.' &nbsp;</td>
</tr>
';
}
...
<td width="78px" align="right"><div style="border-top: 1px solid #000000 ;"><b>'.$pdf->decimales($suma_peso_bruto,2).'</b> &nbsp;</div></td>
<td width="5px">&nbsp;</td>
<td width="61px" align="right"><div style="border-top: 1px solid #000000 ;"><b>'.$pdf->decimales($suma_tara,2).'</b> &nbsp;</div></td>
<td width="5px">&nbsp;</td>
<td width="66px" align="right"><div style="border-top: 1px solid #000000 ;"><b>'.$pdf->decimales($suma_pneto,2).'</b> &nbsp;</div></td>
<td width="55px" align="right">&nbsp;</td>
<td width="71px" align="right"><div style="border-top: 1px solid #000000 ;"><b>'.$pdf->decimales($suma_dcto_hum,2).'</b> &nbsp;</div></td>
<td width="55px" align="right">&nbsp;</td>
<td width="67px" align="right"><div style="border-top: 1px solid #000000 ;"><b>'.$pdf->decimales($suma_dcto_imp,2).'</b> &nbsp;</div></td>
<td width="5px">&nbsp;</td>
<td width="90px" align="right"><div style="border-top: 1px solid #000000;"><b>'.$pdf->decimales($suma_pacondicionado,2).' </b>&nbsp;</div></td>
</tr>
</table>
';
