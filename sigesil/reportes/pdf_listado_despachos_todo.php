...
<td width="55px" align="right">&nbsp;</td>
<td width="66px" align="right"><div style="border-top:1px solid #000000;"><b>'.$pdf->decimales($suma_dcto_imp,2).'</b> &nbsp;</div></td>
<td width="5px">&nbsp;</td>
...
<td width="76px" align="right"><div style="border-bottom:1px solid #000000;"><b>'.$pdf->decimales($suma_peso_bruto_general,2).'</b> &nbsp;</div></td>
<td width="65px" align="right">&nbsp;</td>
<td width="90px" align="right">&nbsp;</td>
<td width="55px" align="right">&nbsp;</td>
<td width="71px" align="right"><div style="border-bottom:1px solid #000000;"><b>'.$pdf->decimales($suma_dcto_hum_general,2).'</b> &nbsp;</div></td>
<td width="55px" align="right">&nbsp;</td>
<td width="66px" align="right"><div style="border-bottom:1px solid #000000;"><b>'.$pdf->decimales($suma_dcto_imp_general,2).'</b> &nbsp;</div></td>
<td width="5px">&nbsp;</td>
<td width="100px" align="right"><div style="border-bottom:1px solid #000000;"><b>'.$pdf->decimales($suma_pacondicionado_general,2).'</b>&nbsp;&nbsp;</div></td>
</tr>
</table>
<br /><br />';
