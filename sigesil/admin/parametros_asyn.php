...
?>
 ...
 <input name="valor" id="valor" type="text" value="<?=$parametros->data['parametro_valor']?>" style="width:40%" />
 <input type="button" name="Submit" value="Guardar" onclick="javascript:guardar('<?=$GPC['ids'] ?>');" style="font-size: 10px;" />
