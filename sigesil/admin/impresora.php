...
<form name="form1" id="form1" method="POST" action="?ac=guardar" enctype="multipart/form-data">
    <?php echo $html->input('Impresora.id', $infoImpresora[0]['id'], array('type' => 'hidden')); ?>
    ...
    <table align="center">
        <tr>
            ...
            <td><?php echo $html->select('Impresora.id_centro_acopio', array('options' => $listaCA, 'selected' => $infoImpresora[0]['id_centro_acopio'], 'default' => 'Seleccione', 'class' => 'estilo_campos')) ?></td>
        </tr>
        <tr>
            <td><span class="msj_rojo">* </span>Nombre</td>
            <td><?php echo $html->input('Impresora.nombre', $infoImpresora[0]['nombre'], array('type' => 'text', 'class' => 'estilo_campos')); ?></td>
        </tr>
        <tr>
            <td><span class="msj_rojo">* </span>Reimprimir</td>
            <td><?php echo $html->select('Impresora.estatus', array('options' => $listaEstatus, 'selected' => $infoImpresora[0]['estatus'], 'default' => 'Seleccione', 'class' => 'estilo_campos')) ?></td>
        </tr>
        <tr>
            <td>Parametros</td>
            <td><?php echo $html->input('Impresora.parametros', $infoImpresora[0]['parametros'], array('type' => 'text', 'class' => 'estilo_campos')); ?></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
