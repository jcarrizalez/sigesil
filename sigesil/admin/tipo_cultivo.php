...
<form name="form1" id="form1" method="POST" action="?ac=guardar" enctype="multipart/form-data">
    <?php echo $html->input('CultivoTipo.id', $infoCultivoTipo[0]['id'], array('type' => 'hidden')); ?>
    ...
    <table align="center">
        <tr>
            ...
            <td><?php echo $html->input('CultivoTipo.nombre', $infoCultivoTipo[0]['nombre'], array('type' => 'text', 'class' => 'estilo_campos')); ?></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
