...
class Cosecha extends Model {
    ...
    function buscarCosechaP($id=null, $idP=null){
        $query = "SELECT co.codigo, co.id_programa, co.nombre AS nombre_cosecha, co.proyectado, co.area_siembra, co.fecha_inicio, co.fecha_fin, cu.nombre AS nombre_cultivo
                    FROM si_cosecha co
