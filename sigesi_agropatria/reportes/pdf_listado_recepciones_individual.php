...
for($z=0; $z<count($listadoRecepciones_); $z++)     //   FORRECPCUIONES
{
				...
				$hum=$pdf->decimales($listadoRecepciones_[$z]['humedad'],3); //echo '<br />'.$listadoRecepciones_[$z]['humedad'];
			  $suma_hum+=$listadoRecepciones_[$z]['humedad'];
				$imp=$pdf->decimales($listadoRecepciones_[$z]['impureza'],3);
...
/*
				...
				<td width="5px">&nbsp;</td>
				<td width="105px" align="right">'.$pacondicionado_liq.' &nbsp;</td>
...
for($z=0; $z<count($listadoRecepciones_); $z++)     //   FORRECPCUIONES
{
				...
				<td align="right">'.$pdf->decimales($pesoneto,3).' </td>
				<td>&nbsp;</td>
				<td align="right">'.$pdf->decimales($hum,3).' </td>
				<td>&nbsp;</td>
				<td align="right">'.$dcto_hum_.' &nbsp;</td>
				<td>&nbsp;</td>
...
<td width="224px" align="right"><div><b>Total: &nbsp;&nbsp;&nbsp;&nbsp;</b></div></td>
