...
$validator->setRules('Paciente.cedula', array(
    ...
    'minlength' => array('value' => 7, 'message' => 'Minimo 7 Digitos'),
                ...
                <? } else { ?>
                    ...
                    <table id="table_login2" border="0" width="100%">
                        <tr>
                            <td class="titulos">
                                CONSULTA
                                <img src="<?= DOMAIN_ROOT ?>images/consulta.png" width="60" height="60" alt="lista_paciente" style="vertical-align: middle;" />
                            </td>
                        </tr>
                        <tr>
