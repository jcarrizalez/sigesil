...
<form name="form1" id="form1" method="POST" action="" enctype="multipart/form-data">
    ...
    <fieldset>    
        ...
        <table align="center" border="0">
            ...
            <tr>
                <td>Cultivo</td>
                <td colspan="4"><?php echo $html->select('Cuarentena.id_cultivo', array('options' => $listaCultivo, 'selected' => $infoCtna[0]['id_cultivo'], 'readOnly' => true)); ?></td>
            </tr>
            <tr>
    ...
    <fieldset>    
        ...
        <table align="center" border="0">
            <tr>
                ...
                <td align="center">
                <textarea name="Cuarentena[observa_admon]" cols="50" rows="2" id="Cuarentena[observa_admon]"><?php echo $infoCtna[0]['observa_admon']?></textarea></td>
                </td>
            </tr>
        </table>
    </fieldset>
